...
# Load data 
# Load the CSV file
file_path = "new_project/FIC-211_20241121~27.csv"  
df = pd.read_csv(file_path)

# Convert each column directly into arrays
pv = df["FT_211"].to_numpy()
co = df["FV_211"].to_numpy()
# Reverse array since time is reversed
pv = np.flip(pv)
co = np.flip(co)

# Plot PV SP, and CO
plot_pv_sp_op(pv = pv, sp = None,co = co, loop_name = "flow_211")

# Thesis 1 (Statistical)
"""# Method1"""
# method1 = Method1(pv, co)
# method1.perform()
# method1.store_csv("flow")
# print(f"sum of s:{sum(method1.s)}")

"""# Method2"""
# method2 = Method2(pv, co)
# method2.perform()
# method2.store_csv("flow")
# print(f"sum of s:{sum(method2.s)}")
"""# Method3"""
# method3 = Method3(pv, co)
# method3.perform()
# method3.store_csv("flow")
"""# Method4"""
# method4 = Method4(pv, co)
# method4.perform()
# method4.store_csv("flow")

"""Use after the csv stored"""
"""method1 stiction signal"""
# s_method1 = np.loadtxt('new_project/csv/essay_1/stiction_signal_method1_flow.csv', delimiter=',')
# S_method1_expand = np.repeat(s_method1, 8)
"""method2 stiction signal"""
# s_method2 = np.loadtxt('new_project/csv/essay_1/stiction_signal_method2_flow.csv', delimiter=',')
# S_method2_expand = np.repeat(s_method2, 8)
"""method3 stiction signal"""
# s_method3 = np.loadtxt('new_project/csv/essay_1/stiction_signal_method3_flow.csv', delimiter=',')
# S_method3_expand = np.repeat(s_method3, 8)
"""method4 stiction signal"""
# s_method4 = np.loadtxt('new_project/csv/essay_1/stiction_signal_method4_flow.csv', delimiter=',')
